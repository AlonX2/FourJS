...
class Body extends EventTarget {
  ...
  set mass(val){
    this._mass = val;
    if(typeof this.shapes !== 'undefined' && this.type !== Body.STATIC){ // first part is for checking if the body has been fully initialized before updating mass properties, second is checking if its static and if so not needing update.
      this.updateMassProperties();
    }
  }
  get mass(){
